...
- Display Native RGB best-effort output using reported display primaries on Advanced Color displays
- Full-range device RGB endpoint output for Display Native RGB on legacy SDR displays
...
The Display Native RGB mode reports its per-monitor output path and reported or estimated
primaries in the one-second overlay. It does not guarantee direct physical subpixel control
or measured maximum panel luminance.
